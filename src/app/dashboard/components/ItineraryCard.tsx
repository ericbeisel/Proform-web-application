...
export default function ItineraryCard({ weeklyTargets, completionPercentage = 0 }: ItineraryCardProps) {
  ...
  return (
    <div className="bg-[#1c1929] rounded-2xl p-5 shadow-[0_2px_12px_rgba(108,92,231,0.07)] border border-transparent">
      ...
      <div className="text-[#fd7b4d] text-xl font-bold mt-1">
        {completionPercentage}<span className="text-sm opacity-60 ml-1">%</span>
      </div>
      <div className="grid grid-cols-2 gap-2 mt-4">
        <div className="bg-white/6 rounded-lg p-2.5 text-center">
          <div className="text-white text-xl font-bold">0/{targets.workout}</div>
          <div className="text-white/40 text-[10px] mt-0.5">Workout</div>
        </div>
        <div className="bg-white/6 rounded-lg p-2.5 text-center">
          <div className="text-white text-xl font-bold">0/{targets.supplement}</div>
          <div className="text-white/40 text-[10px] mt-0.5">Supplemental</div>
        </div>
        <div className="bg-white/6 rounded-lg p-2.5 text-center">
          <div className="text-white text-xl font-bold">0/{targets.conditioning}</div>
