    ...
    <div className="relative bg-gradient-to-r from-[#fd7b4d] to-[#e05252] rounded-2xl p-6 flex items-center gap-5 overflow-hidden shadow-lg">
      ...
      <div className="z-10">
        ...
        <p className="text-white/80 text-sm mt-1">
          You have 26 days remaining to create your player card and complete your profile setup!
        </p>
      </div>
      <button className="ml-auto bg-white text-[#e17055] px-5 py-2.5 rounded-[10px] font-semibold text-sm whitespace-nowrap hover:shadow-xl hover:-translate-y-0.5 transition-all z-10">
        Create Player Card Now
      </button>
      <button className="absolute top-3 right-3 w-6 h-6 rounded-full bg-white/18 text-white text-xs flex items-center justify-center z-10 hover:bg-white/30 transition">
        <X size={14} />
      </button>
