...
<div className="bg-white px-4 sm:px-6 lg:px-7 py-3.5 sm:py-4 flex items-center justify-between border-b border-[#e8e8f0] sticky top-0 z-10">
  ...
  <div className="flex items-center gap-2 sm:gap-4">
    ...
    {/* Edit Queue Button + Plus Button - Together at the far right */}
...
{!error && sessions.length === 0 && (
  <div className="max-w-6xl mx-auto px-4 mt-12">
    <div className="bg-white rounded-2xl p-8 text-center shadow-sm border border-gray-100">
      ...
      {/* Message based on selected type */}
      ...
      {/* Main Content - Centered + Cards with Cover Photo Background */}
   {/* Main Content - Grid Layout */}
{sessions.length > 0 && (
  <div className="p-4 sm:p-5 lg:p-7">
    {/* Header Section with Total Workouts and Edit Button */}
      ...
      {sessions.map((session) => (
        ...
        >
          ...
          <div className="relative p-4 sm:p-5 flex flex-col h-full min-h-[220px]">
            {/* Top Row - Type Badge on Top Right */}
            ...
            {/* Middle Content - Day/Time and Title */}
