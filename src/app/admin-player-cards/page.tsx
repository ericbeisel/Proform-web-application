...
export default function PlayerCardPage() {
  ...
  // Check if we have a selected file AND a selected card type when trying to submit
  ...
  try {
    ...
    // Use "type" as the field name (not "cardType")
    if (selectedCardType) formData.append("type", selectedCardType);
  ...
  //     if (selectedFile) formData.append("inBodyScans", selectedFile);
  //     if (progressFile) formData.append("progressImage", progressFile);
  //     if (selectedCardType) formData.append("cardType", selectedCardType);
  ...
  // };
    ...
    router.push("/admin-player-progress");
  };
